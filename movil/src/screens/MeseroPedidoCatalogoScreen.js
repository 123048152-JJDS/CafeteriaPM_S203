  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.botonContainer}>
        <BotonPrimario titulo="Ver resumen" onPress={onVerResumen} />
      </View>
    </SafeAreaView>
  )
}
...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 14, borderRadius: 10, backgroundColor: '#f9f9f9', borderWidth: 1, borderColor: '#eeeeee' },
